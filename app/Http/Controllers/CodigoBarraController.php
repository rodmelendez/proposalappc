...
class CodigoBarraController extends CodigoBarra {
    /**
    ...
    public function imagen($valor, $attrs = null) {
        $barra = $this->getBarcode($valor, self::TYPE_CODE_128);
        ...
        return '<img class="barcode" src="data:image/png;base64,' . base64_encode($barra) . '" alt="' . $valor . '"' . $attrs_str . '>';
    }
}
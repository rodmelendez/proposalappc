            ...
            <div class= "col-xl-12" >
              ...
              <div class=galery-carousel>
                <carousel
                    ...
                    :pagination-enabled="false"
                >
                  <transition v-for="( imageFile , index) in imageFiles" :key="index">
                    <galery-item
...
Vue.component('galeria-item', require('../GaleriaItem.vue').default);/*no afecta al componente*/
Vue.component('galery-item', require('../others/GaleryItem.vue').default);/*si afecta al componente*/
